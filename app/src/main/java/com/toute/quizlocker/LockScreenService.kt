...
class LockScreenService : Service() {
    ...
    private val ANDROID_CHANNEL_ID = "com.toute.quizlocker"
    ...
    // 서비스를 호출하는 클라리언트가 startService() 함수를 호출할때마다 불리는 콜백함수
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val chan = NotificationChannel(ANDROID_CHANNEL_ID, "MyService",
